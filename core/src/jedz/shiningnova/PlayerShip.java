...
class PlayerShip extends Ship {
    ...
    public Laser[] fireLasers() {
        ...
        laser[0] = new Laser(laserMovementSpeed,xPosition+width*0.07f,yPosition+height*0.45f,laserWidth,laserHeight,laserTextureRegion);
        laser[1] = new Laser(laserMovementSpeed,xPosition+width*0.93f,yPosition+height*0.45f,laserWidth,laserHeight,laserTextureRegion);
